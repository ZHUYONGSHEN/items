    ...
    <div class="C-messages " style="border-radius: 0">
        <div class="C-list clearfix">
            ...
            <div class="form-group">
                ...
                <input type="text" name="code" minlength="6" maxlength="6" disabled="disabled" data-code="false" style=" float: left; width: 3.21rem;" class="form-control" placeholder="请输入验证码">
            </div>
            <div class="form-group">
