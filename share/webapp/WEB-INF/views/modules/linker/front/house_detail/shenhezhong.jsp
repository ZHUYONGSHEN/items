...
<style>
	*{box-sizing:border-box;margin:0;padding:0;}
	...
	.icons{width:2rem;height:2rem;background:url('${backStatic}/images/icon_shenhezhong.png') no-repeat center;background-size:cover;margin:0 auto;margin-top:1rem;margin-bottom:0.5rem;}
</style>
</head>
<body>
	<div id="container">
		<div class="icons"></div>
		<div style="text-align:center;color:#333;font-size:0.36rem;margin-bottom:0.5rem;">审核中</div>
		<p style="text-align:center;color:#ccc;">系统将于2个工作</p>
		<p style="margin-bottom:.5rem;text-align:center;color:#ccc;">日内返回结果。请您耐心等待</p>
